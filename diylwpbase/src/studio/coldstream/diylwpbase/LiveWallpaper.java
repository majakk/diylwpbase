...
public class LiveWallpaper extends BaseLiveWallpaperService implements SharedPreferences.OnSharedPreferenceChangeListener, IOffsetsChanged
{
	...
	public static final String SHARED_PREFS_NAME = "diylivewallpapersettings";

	//Camera Constants
	private static final int CAMERA_WIDTH = 480;
	private static final int CAMERA_HEIGHT = 720;

	private String MODE = "lipslemonade";
	...
	//private String preset5 = "1!2"; //preset5
	...
	{				
		...
		MODE = mSharedPreferences.getString("livewallpaper_mode", "lipslemonade");
	...
	public Scene BuildScene(Scene scene){
		...
		else if(MODE.matches("makersview") && creative.contentEquals("")){
		...
		else if(MODE.matches("kingmidas") && creative.contentEquals("")){
			scene.setBackground(new ColorBackground(0.3f, 0.2f, 0.0f));			
			creative = preset5;
		}*/
		else{
